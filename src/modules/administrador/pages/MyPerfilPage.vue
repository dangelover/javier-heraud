    ...
    <div class="profile__content">
      ...
      <div class="profile__links">
        <a class="profile__link" href="#">
          <i class="profile__link__icon fas fa-phone-alt"></i>
          <span class="profile__link__text">{{ celular }}</span>
        </a>
        <a class="profile__link" href="#">
          <i class="profile__link__icon fa fa-envelope"></i>
          <span class="profile__link__text">{{ correo }} </span>
        </a>
      </div>
      <div class="profile__twitter">
        <div class="profile__twitter__follow">
          <button class="profile__twitter__follow__button">{{ cargo }}</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions("administrador", ["perfilAdministrador"]),
    async LoadAdmin() {
      const usuario = localStorage.getItem("usuario");
      this.user = JSON.parse(usuario);
      //   console.log(this.user.DNI);
      const body = await this.perfilAdministrador(this.user.DNI);
      console.log(body);
      const {
        nombre,
        apellido,
