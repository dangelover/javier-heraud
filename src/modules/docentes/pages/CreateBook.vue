<template>
  <div class="cont-cntrl">
    <div class="container_edu_b_catp">
      <h2 class="tittle-edu-catp">Cargar Libro</h2>
      <div class="form-edu-catp">
        <div class="cont-act">
          ...
          <div class="act-form">
            ...
            <div class="form-ti">
              <label for="">Cargar Portada</label>
              <input
                type="file"
...
export default {
  ...
  methods: {
    ...
    async onUpdateBook() {
      ...
      const body = await this.UpdateBook(this.data);
      console.log(body);
      if (body.condicion) {
      ...
      this.$router.push({ name: "subir-libros" });
    },
