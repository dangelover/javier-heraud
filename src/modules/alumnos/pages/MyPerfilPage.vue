      ...
      <div class="profile__content">
        ...
        <div class="profile__links">
          <a class="profile__link"
            ><i class="profile__link__icon fas fa-birthday-cake"></i
            ><span class="profile__link__text">{{ fecha_nacimiento }}</span></a
          >
        </div>
        <div class="profile__twitter">
          <div
            class="profile__twitter__stats profile__twitter__stats--followers"
          >
            <span class="profile__twitter__stats__count">{{ grado }}</span
            ><span class="profile__twitter__stats__label">Grado</span>
          </div>
          <div
            class="profile__twitter__stats profile__twitter__stats--following"
          >
          ...
          <div class="profile__twitter__follow">
            <button class="profile__twitter__follow__button">Alumno</button>
          </div>
        </div>
      </div>
    </div>
